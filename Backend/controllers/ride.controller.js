...
module.exports.createRide = async (req, res) => {
    ...
    try {
        ...
        // ⚠️ TEST ONLY: radius is set very large so any captain matches.
        //    Revert to 2 before demo.
        ...
        console.log(`[RIDE] Captain socketIds:`, captainsInRadius.map(c => c.socketId));
