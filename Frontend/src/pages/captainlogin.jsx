      ...
      <div className="flex-1 flex flex-col justify-center">
        <div className="w-full max-w-md mx-auto">
          ...
          <form onSubmit={(e) => {
            ...
            <h1 className="text-2xl font-semibold mb-6">What's your phone number and email</h1>

            <h2 className="text-base font-medium mb-2">What's your email, Captain?</h2>
            <input 
              type="email" 
          ...
          <p className="text-center mb-6 text-sm">
            New here? <Link to="/captain-signup" className='text-blue-600 font-medium hover:underline'>Create an Account</Link>
          </p>
        </div>
      </div>

      {/* Bottom section - Login as User button */}
      <div className="w-full max-w-md mx-auto">
        <Link 
          to="/user-login" 
